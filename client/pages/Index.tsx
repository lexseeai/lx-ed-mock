        ...
        >
          ...
          >
            <Avatar className="w-full h-full">
              <AvatarFallback
                className={`${getSubjectColors()} font-medium text-sm`}
              >
...
function Sidebar({
  ...
  return (
    <div
      className={`${isCollapsed ? "w-16 min-w-16" : "w-60 min-w-60"} flex flex-col min-h-screen transition-all duration-300 flex-shrink-0`}
    >
      {/* Header */}
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    let selectedDay = currentWeekDays.find(
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        sidePanelDropdownRef.current &&
        !sidePanelDropdownRef.current.contains(event.target as Node)
      ) {
  ...
  const studentsWithUpcomingSessions = mockStudents.filter(
    (s) => s.upcomingSession,
  );
            ...
            >
                      ...
                      <div className="flex gap-1.5 overflow-x-auto scrollbar-hide">
                        {(() => {
                          ...
                          return visibleDays.map((dayData, index) => {
                            const originalIndex = currentWeek.findIndex(
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            ...
                            transition:
                              "left 0.15s cubic-bezier(0.34, 1.25, 0.64, 1)",
                          }}
                        />
                        <button
                  ...
                  <div className="flex justify-center">
                    <div className="relative w-96 mx-auto">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setAllStudentsSearchQuery(e.target.value)
                        }
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      >
                        ...
                        <Input
                          type="text"
                          placeholder={
                            selectedNotesStudentFilter || "Filter by student"
                          }
                          value={
                            selectedNotesStudentFilter
                              ? ""
                              : notesStudentSearchQuery
                          }
                          onChange={(e) => {
                            ...
                            {getFilteredStudentNames()
                              ...
                              .filter((name) =>
                                name
                                  .toLowerCase()
                                  .includes(
                                    notesStudentSearchQuery.toLowerCase(),
                                  ),
                              )
                              .map((name) => (
                                <button
              ...
              >
                {activeView === "home" && (
                  <div className="space-y-16">
                    ...
                    <div>
                      ...
                      <div className="flex gap-4 overflow-x-auto pb-2">
                        {(() => {
                          const lateDraftStudents = mockStudents.filter(
                            (student) =>
                              getSessionReportStatus(student) === "late",
                          );
                ...
                {activeView === "all" && (
                  <section
                    className={
                      studentsViewMode === "list" ? "h-full flex flex-col" : ""
                    }
                  >
                    {studentsViewMode === "cards" ? (
                      <div className="flex justify-center">
                  ...
                  {studentDetailTab === "observations" && (
                    <div className="text-center py-12">
                      <p className="text-stone-500 font-lexend">
                        Observations content coming soon...
                      </p>
                    </div>
                  )}
