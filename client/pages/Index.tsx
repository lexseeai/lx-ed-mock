                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-1.5">
                          ...
                          <p className="text-base font-normal text-stone-900 font-lexend leading-5">
                            ...
                            <span className="relative inline-block" style={{verticalAlign: 'middle', marginLeft: '4px', height: 'auto', lineHeight: '20px'}}>
                              <span className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-stone-100 hover:bg-stone-700 transition-colors cursor-pointer group" style={{lineHeight: '20px', height: '14px', flexGrow: 0, verticalAlign: '4px'}}>
                        ...
                        <div className="flex items-start gap-1.5">
                          ...
                          <p className="text-base font-normal text-stone-900 font-lexend leading-5">
                            ...
                            <span className="relative inline-block ml-1" style={{verticalAlign: 'baseline'}}>
                              <span className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-stone-100 hover:bg-stone-700 transition-colors cursor-pointer group">
                                <span className="text-stone-400 group-hover:text-white font-lexend leading-3 font-normal" style={{fontSize: '8px'}}>14 July 25</span>
                              </span>
                              <span className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                                <span className="block bg-stone-100 px-3 py-1.5 rounded shadow-md pointer-events-auto">
                                  <span className="text-stone-900 font-lexend text-sm whitespace-nowrap">View session notes</span>
                        ...
                        <div className="flex items-start gap-1.5">
                          ...
                          <p className="text-base font-normal text-stone-900 font-lexend leading-5">
                            ...
                            <span className="relative inline-block ml-1" style={{verticalAlign: 'baseline'}}>
                              <span className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-stone-100 hover:bg-stone-700 transition-colors cursor-pointer group">
                                <span className="text-stone-400 group-hover:text-white font-lexend leading-3 font-normal" style={{fontSize: '8px'}}>7 July 25</span>
                              </span>
                              <span className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                                <span className="block bg-stone-100 px-3 py-1.5 rounded shadow-md pointer-events-auto">
                                  <span className="text-stone-900 font-lexend text-sm whitespace-nowrap">View session notes</span>
                        ...
                        <div className="flex items-start gap-1.5">
                          ...
                          <p className="text-base font-normal text-stone-900 font-lexend leading-5">
                            ...
                            <span className="relative inline-block ml-1" style={{verticalAlign: 'baseline'}}>
                              <span className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-stone-100 hover:bg-stone-700 transition-colors cursor-pointer group">
                                <span className="text-stone-400 group-hover:text-white font-lexend leading-3 font-normal" style={{fontSize: '8px'}}>30 June 25</span>
                              </span>
                              <span className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                                <span className="block bg-stone-100 px-3 py-1.5 rounded shadow-md pointer-events-auto">
                                  <span className="text-stone-900 font-lexend text-sm whitespace-nowrap">View session notes</span>
                        ...
                        <div className="flex items-start gap-1.5">
                          ...
                          <p className="text-base font-normal text-stone-900 font-lexend leading-5">
                            ...
                            <span className="relative inline-block ml-1" style={{verticalAlign: 'baseline'}}>
                              <span className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-stone-100 hover:bg-stone-700 transition-colors cursor-pointer group">
                                <span className="text-stone-400 group-hover:text-white font-lexend leading-3 font-normal" style={{fontSize: '8px'}}>23 June 25</span>
                              </span>
                              <span className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                                <span className="block bg-stone-100 px-3 py-1.5 rounded shadow-md pointer-events-auto">
                                  <span className="text-stone-900 font-lexend text-sm whitespace-nowrap">View session notes</span>
