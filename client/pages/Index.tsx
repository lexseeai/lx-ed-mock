                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-1.5">
                          ...
                          <p className="text-base font-normal text-stone-900 font-lexend leading-5">
                            ...
                            <span className="relative inline-block" style={{verticalAlign: 'middle', marginLeft: '4px'}}>
                              <span className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-stone-100 hover:bg-stone-700 transition-colors cursor-pointer group" style={{transform: 'translateY(-2px)'}}>
