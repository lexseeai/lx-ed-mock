...
import { UsersRound, NotebookText, LibraryBig, FileAudio, Rabbit, ChevronsUpDown, PanelLeft, Clock, Calendar, Bell, ChevronLeft, ChevronRight, ChevronDown, Haze, SunMedium, MoonStar, X, Maximize2, MoreVertical } from "lucide-react";
    ...
    <div className="h-screen bg-indigo-900 flex">
      ...
      {showStudentOverlay && selectedStudentId && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[1000]">
          ...
          {/* Modal Content */}
          <div className="bg-blue-50 rounded-lg border border-stone-200 shadow-xl max-w-2xl w-full mx-8 max-h-[85vh] max-w-[90vw] overflow-y-auto">
            {/* Header */}
