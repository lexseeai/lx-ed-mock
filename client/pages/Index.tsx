...
import { UsersRound, NotebookText, LibraryBig, FileAudio, Rabbit, ChevronsUpDown, PanelLeft, Clock, Calendar, Bell, ChevronLeft, ChevronRight, ChevronDown, Haze, SunMedium, MoonStar, X, Maximize2, MoreVertical, Loader, Timer, NotebookPen, CircleCheck, Edit, Pencil, ChevronsLeft, ChevronsRight, ChevronUp, ArrowRight, UserRoundSearch, LoaderCircle, UserRound, Search, UserRoundPlus, Plus, ChevronUp as SortAsc, ChevronDown as SortDesc, LayoutGrid, Table as TableIcon } from "lucide-react";
                  ...
                  <div className="flex items-center justify-between w-full mb-6" style={{marginBottom: '24px', paddingRight: '4px'}}>
                    ...
                    <div className="relative" ref={homeDropdownRef}>
                      <button
                        ...
                        className="flex items-center justify-center w-11 h-11 bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-colors shadow-sm overflow-hidden"
                      >
