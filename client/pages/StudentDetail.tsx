        ...
        <div className="flex-1 flex flex-col h-full min-w-0 overflow-hidden">
          ...
          <div className="flex-1 p-3 h-full min-w-0">
            <Card className="h-full flex flex-col min-w-0">
              ...
              {/* Tab Navigation - Hide when in sidebar views */}
              {(activeView === 'student' || activeView === 'home' || !activeView || activeView === 'all') && (
              ...
              <div className="flex-1 overflow-y-auto p-8 bg-stone-50">
                  ...
                  <div className="space-y-6">
                    <div className="text-center py-8">
                      ...
                      <div className="max-w-4xl mx-auto space-y-4">
                          ...
                          <CardContent className="p-0">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-stone-600 font-lexend">Math Tutoring with {student.name}</p>
                        ...
                        {/* More upcoming sessions for all students */}
                        <Card className="p-5 text-left">
                          <CardContent className="p-0">
                            <div className="flex items-center justify-between">
                              <div>
                                <h3 className="text-lg font-bold text-stone-900 font-lexend">August 11, 2025</h3>
                                <p className="text-sm text-stone-600 font-lexend">Science Tutoring with Emma</p>
                                <p className="text-sm text-stone-600 font-lexend">4:00 - 4:45 PM</p>
                              </div>
                              <div className="flex gap-2">
                                <Button size="sm" variant="outline" className="font-lexend">
                                  View Details
                      ...
                      <div className="max-w-4xl mx-auto space-y-4">
                          ...
                          <CardContent className="p-0">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-stone-600 font-lexend">Math Tutoring with {student.name} - 3:00-3:45 AM</p>
                        ...
                        <Card className="p-5 text-left">
                          <CardContent className="p-0">
                            <div className="flex items-center justify-between">
                              <div>
                                <h3 className="text-lg font-bold text-stone-900 font-lexend">Session Report - August 1, 2025</h3>
                                <p className="text-sm text-stone-600 font-lexend">Science Tutoring with Emma - 4:00-4:45 PM</p>
                                <p className="text-sm text-amber-600 font-lexend mt-1">Due: August 3, 2025</p>
                              </div>
                              <div className="flex gap-2">
                                <Button size="sm" variant="outline" className="font-lexend">
                ...
                {(activeView === 'student' || activeView === 'home' || !activeView || activeView === 'all') && activeTab === 'snapshot' && (
                ...
                {(activeView === 'student' || activeView === 'home' || !activeView || activeView === 'all') && activeTab === 'search' && (
                  <div className="text-center py-12">
                    <p className="text-stone-500 font-lexend">Search functionality coming soon...</p>
                  </div>
                )}

                {(activeView === 'student' || activeView === 'home' || !activeView || activeView === 'all') && activeTab === 'goals' && (
                  <div className="text-center py-12">
                    <p className="text-stone-500 font-lexend">Goals content coming soon...</p>
                  </div>
                )}

                {(activeView === 'student' || activeView === 'home' || !activeView || activeView === 'all') && activeTab === 'session-notes' && (
                  <div className="text-center py-12">
                    <p className="text-stone-500 font-lexend">Session notes content coming soon...</p>
                  </div>
                )}

                {(activeView === 'student' || activeView === 'home' || !activeView || activeView === 'all') && activeTab === 'assignments' && (
                  <div className="text-center py-12">
