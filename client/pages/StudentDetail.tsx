                            ...
                            <div className="flex flex-col gap-3">
                              ...
                              <div className="space-y-3 pl-1.5">
                                ...
                                <div className="flex gap-1.5">
                                  ...
                                  <p className="text-stone-900 font-lexend text-base leading-5 flex-1">
                                    Demonstrated improved accuracy in
                                    identifying decimal positions with visual
                                    support.{" "}
                                    <span
                                      className="relative inline-block group"
                                      style={{
                                ...
                                <div className="flex gap-1.5">
                                  ...
                                  <p className="text-stone-900 font-lexend text-base leading-5 flex-1">
                                    Made progress toward independent
                                    problem-solving with fewer rounding errors.{" "}
                                    <span
                                      className="relative inline-block group"
                                      style={{
                                        verticalAlign: "middle",
                                ...
                                <div className="flex gap-1.5">
                                  ...
                                  <p className="text-stone-900 font-lexend text-base leading-5 flex-1">
                                    Joined the session late but used remaining
                                    time effectively to reinforce key math
                                    skills.{" "}
                                    <span
                                      className="relative inline-block group"
                                      style={{
                                ...
                                <div className="flex gap-1.5">
                                  ...
                                  <p className="text-stone-900 font-lexend text-base leading-5 flex-1">
                                    Worked on comparing fractions using visual
                                    models and practiced breaking down
                                    multi-step word problems. Demonstrated
                                    initial understanding with support and is
