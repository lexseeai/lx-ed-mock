                                  ...
                                  <p className="text-stone-900 font-lexend text-sm leading-relaxed flex-1">
                                    ...
                                    >
                                      <span
                                        ...
                                        className="inline-flex items-center justify-center px-1 py-0.5 rounded-full bg-white border border-stone-200 group-hover:bg-stone-700 group-hover:border-stone-700 transition-colors cursor-pointer"
                                        style={{
                                          lineHeight: "20px",
                                          height: "14px",
                                          flexGrow: 0,
                  ...
                  <div className="flex h-full">
                    ...
                    >
                      ...
                      {selectedSessionId === "august-1" && (
                        <div className="bg-white rounded-lg border border-stone-200 shadow-sm overflow-hidden h-full max-w-[650px] w-full flex flex-col">
                          {/* Fixed Header */}
                          <div className="flex items-start justify-between p-5 flex-shrink-0">
                            <div className="flex items-start gap-1.5 justify-start">
